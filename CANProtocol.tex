...
\end{scope}
\draw[dashed, black] (canframe-1-20.south west) -- (dats-1-1.north west);
\draw[dashed, black] (canframe-1-23.south east) -- (dats-1-32.north east);
\draw[thick,black] (dats-1-1.north west) -- (dats-1-32.north east);
\draw[thick,black] (dats-1-1.south west) -- (dats-1-32.south east);
